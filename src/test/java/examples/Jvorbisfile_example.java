...
/**
 * Takes a vorbis bitstream from an input file and writes raw stereo PCM to an output file using
 * JOggVorbis_File. Using JOggVorbis_File is much simpler than dealing with libvorbis.
 */
public final class Jvorbisfile_example {
  private static final byte pcmout[] =
      new byte[4096]; /* take 4k out of the data segment, not the stack */
  ...
  public static void main(final String[] args) {
    if (args.length != 2) {
      ...
      System.out.println(
          "java -jar OggVorbisFile_example.jar <Input File[.ogg]> <Output File[.raw]>");
      System.exit(0);
      return;
    }
