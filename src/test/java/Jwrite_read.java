...
public class Jwrite_read {
  ...
  public static void write_vorbis_data_or_die(
  ...
  @SuppressWarnings("boxing")
  public static void read_vorbis_data_or_die(
      final String filename, final int srate, final float[] data, final int count) {
