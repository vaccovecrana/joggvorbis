...
import io.vacco.libvorbis.Jve_setup_data_template;
...
public final class Jsetup_16 {
  ...
  private static final int _floor_mapping_16a[] = {9, 3, 3};

  private static final int _floor_mapping_16b[] = {9, 9, 9};

  protected static final int _floor_mapping_16[][] = {_floor_mapping_16a, _floor_mapping_16b};
  ...
  public static final Jve_setup_data_template ve_setup_16_stereo =
      new Jve_setup_data_template(
          3,
          rate_mapping_16,
          quality_mapping_16,
          2,
  ...
  public static final Jve_setup_data_template ve_setup_16_uncoupled =
      new Jve_setup_data_template(
          3,
