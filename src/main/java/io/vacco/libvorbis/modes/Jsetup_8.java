...
public final class Jsetup_8 {
  ...
  private static final int _floor_mapping_8a[] = {6, 6};

  protected static final int _floor_mapping_8[][] = {_floor_mapping_8a};
  ...
  public static final Jve_setup_data_template ve_setup_8_stereo =
  ...
  public static final Jve_setup_data_template ve_setup_8_uncoupled =
      new Jve_setup_data_template(
          2,
