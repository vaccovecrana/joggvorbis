...
import io.vacco.libvorbis.Jvorbis_info_psy;
import io.vacco.libvorbis.Jvorbis_info_psy_global;
...
public final class Jpsych_44 {
  ...
  protected static final Jvorbis_info_psy_global _psy_global_44[] = { // [5]
    ...
    new Jvorbis_info_psy_global(
        ...
        new float[] {-60.f, -30.f, -40.f, -40.f, -40.f, -40.f, -40.f},
        2,
        -75.f,
        -6.f,
        new int[] {99},
    ...
    new Jvorbis_info_psy_global(
        ...
        new float[] {-40.f, -30.f, -25.f, -25.f, -25.f, -25.f, -25.f},
        2,
        -80.f,
        -6.f,
        new int[] {99},
    ...
    new Jvorbis_info_psy_global(
        ...
        new float[] {-20.f, -20.f, -15.f, -15.f, -15.f, -15.f, -15.f},
        0,
        -80.f,
        -6.f,
        new int[] {99},
    ...
    new Jvorbis_info_psy_global(
        ...
        new float[] {-20.f, -15.f, -12.f, -12.f, -12.f, -12.f, -12.f},
        0,
        -80.f,
        -6.f,
        new int[] {99},
    ...
    new Jvorbis_info_psy_global(
        ...
        new float[] {-15.f, -15.f, -12.f, -12.f, -12.f, -12.f, -12.f},
        0,
        -85.f,
        -6.f,
        new int[] {99},
  ...
  protected static final Jcompandblock _psy_compand_44[] = { // [6]
    ...
    new Jcompandblock(
        new int[] {
          0, 1, 2, 3, 4, 5, 6, 7, /* 7dB */ 8, 9, 10, 11, 12, 13, 14, 15, /* 15dB */ 16, 17, 18, 19,
          20, 21, 22, 23, /* 23dB */ 24, 25, 26, 27, 28, 29, 30, 31, /* 31dB */ 32, 33, 34, 35, 36,
          37, 38, 39, /* 39dB */
        }),
  ...
  protected static final Jvp_adjblock _vp_tonemask_adj_longblock[] = { // [12]
    ...
    new Jvp_adjblock(
        new int[] {-3, -8, -13, -15, -10, -10, -10, -10, -10, -10, -10, 0, 0, 0, 0, 0, 0}), /* -1 */
    new Jvp_adjblock(
        new int[]
  ...
  protected static final Jvp_adjblock _vp_tonemask_adj_otherblock[] = { // [12]
    /* 63     125     250     500       1       2       4       8      16 */
    new Jvp_adjblock(
        new int[] {-3, -8, -13, -15, -10, -10, -9, -9, -9, -9, -9, 1, 1, 1, 1, 1, 1}), /* -1 */
    new Jvp_adjblock(
        new int[]
  ...
  public static final Jvorbis_info_psy _psy_info_template =
      new Jvorbis_info_psy(
          /** blockflag */
          -1,
