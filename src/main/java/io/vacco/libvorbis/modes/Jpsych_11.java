...
public final class Jpsych_11 {
  ...
  protected static final double _psy_lowpass_11[] = {
    4.5, 5.5, 30.,
  }; // [3]
  ...
  protected static final Jvp_adjblock _vp_tonemask_adj_11[] = { // [3]
    ...
    new Jvp_adjblock(
        new int[] {-20, -20, -20, -20, -20, -16, -10, 0, 0, 0, 0, 10, 2, 0, 99, 99, 99}), /* 0 */
    new Jvp_adjblock(
        new int[] {-20, -20, -20, -20, -20, -16, -10, 0, 0, 0, 0, 5, 0, 0, 99, 99, 99}), /* 1 */
    new Jvp_adjblock(
        new int[] {-20, -20, -20, -20, -20, -16, -10, 0, 0, 0, 0, 0, 0, 0, 99, 99, 99}), /* 2 */
  };
