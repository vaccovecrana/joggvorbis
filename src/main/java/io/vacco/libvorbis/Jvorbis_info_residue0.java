...
public final class Jvorbis_info_residue0 extends Jvorbis_info_residue {
  ...
  //
  Jvorbis_info_residue0() {}

  Jvorbis_info_residue0(Jvorbis_info_residue0 r) {
    begin = r.begin;
    end = r.end;
    grouping = r.grouping;
