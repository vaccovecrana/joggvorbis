 ...
 *
 * <p>Copyright (c) 1994-1996 Sun Microsystems, Inc. All Rights Reserved.
 *
 * <p>Permission to use, copy, modify, and distribute this software and its documentation for
 ...
 *
 * <p>SUN MAKES NO REPRESENTATIONS OR WARRANTIES ABOUT THE SUITABILITY OF THE SOFTWARE, EITHER
 * EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO THE IMPLIED WARRANTIES OF MERCHANTABILITY,
 * FITNESS FOR A PARTICULAR PURPOSE, OR NON-INFRINGEMENT. SUN SHALL NOT BE LIABLE FOR ANY DAMAGES
 * SUFFERED BY LICENSEE AS A RESULT OF USING, MODIFYING OR DISTRIBUTING THIS SOFTWARE OR ITS
 * DERIVATIVES.
 *
 * <p>THIS SOFTWARE IS NOT DESIGNED OR INTENDED FOR USE OR RESALE AS ON-LINE CONTROL EQUIPMENT IN
 ...
 * @version @(#)QSortAlgorithm.java 1.3, 29 Feb 1996 extended with TriMedian and InsertionSort by
 *     Denis Ahrens with all the tips from Robert Sedgewick (Algorithms in C++). It uses TriMedian
 *     and InsertionSort for lists shorts than 4. <fuhrmann@cs.tu-berlin.de>
 */
final class FastQSortAlgorithm {
   ...
   * are already sorted, and arrays with duplicate keys.<br>
   * If you think of a one dimensional array as going from the lowest index on the left to the
   * highest index on the right then the parameters to this function are lowest index or left and
   * highest index or right. The first time you call this function it will be with the parameters 0,
   * a.length - 1.
   *
