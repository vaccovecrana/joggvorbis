 ...
 *
 * <p>These values are passed as the <code> parameter</code> of {@link
 * Jvorbis_info#vorbis_encode_ctl}. The type of the referent of that function's <code>arg</code>
 * pointer depends on these codes.
 */
public final class Jencctlcodes {
   ...
   *
   * <p>Deprecated after move to bit-reservoir style management in 1.1 rendered this interface
   * partially obsolete.
   *
   * <p>
   *
