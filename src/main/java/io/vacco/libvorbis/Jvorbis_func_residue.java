...
abstract class Jvorbis_func_residue {
  ...
  abstract int[][] fclass(
      Jvorbis_block vb, Jvorbis_look_residue vl, int[][] in, boolean[] nonzero, int ch);

  abstract int forward(
      Joggpack_buffer opb,
      Jvorbis_block vb,
      Jvorbis_look_residue vl,
      int[][] in,
      boolean[] nonzero,
      int ch,
      int[][] partword,
  ...
  abstract int inverse(
      Jvorbis_block vb, Jvorbis_look_residue vl, float[][] in, boolean[] nonzero, int ch);
  // general
          ...
          for (int k = 0;
            ...
            for (int j = 0; j < ch; j++) {
              ...
              if ((secondstages[n] & s1) != 0) {
                ...
                if (stagebook != null) {
                  if (decodepart.decodepart(stagebook, in[j], i, vb.opb, samples_per_partition)
                      == -1) {
                    return 0; // goto eopbreak;
                  }
                }
