...
public final class Jvorbis_info_mapping0 extends Jvorbis_info_mapping {
  /** <= 16 */
  int submaps = 0;
  ...
  //
  Jvorbis_info_mapping0() {}

  public Jvorbis_info_mapping0(
      int i_submaps,
  ...
  Jvorbis_info_mapping0(Jvorbis_info_mapping0 m) {
    submaps = m.submaps;
